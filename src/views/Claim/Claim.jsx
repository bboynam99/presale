  ...
  return (
    <div id="dashboard-view">
      <div className="presale-header">
		...
		<p>Claim your TICKET and wait for the next ROUND</p>
      </div>
        ...
        {claimedAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span style={{color: "#adc6ff"}}>{claimedAmount} TICKET</span></Typography>
            </div>
          </Grid>
        }
        {claimableAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span style={{color: "#adc6ff"}}>{claimableAmount} TICKET</span></Typography>
            </div>
          </Grid>
        }
        <Grid item>
